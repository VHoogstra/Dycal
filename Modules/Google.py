...
class Google:
  ...
  def processData(self, googleCal, returnObject: ExportReturnObject):
    ...
    googleCal['description'] ="Generated by {} \nlast updated at{}".format(Constants.appname,arrow.get(tzinfo=Constants.timeZone).format('YYYY-MM-DD HH:mm'))
    google_service = self.getCalendarService()
    response =  google_service.update(googleCal)
